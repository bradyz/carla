...
protected:
  ...
  struct ActorInfo {
    ...
    // Returns an ActorInfo with default values for unset variables
...
public:
  ...
  /// Method to set collision detection rules between vehicles.
  virtual void SetCollisionDetection(const ActorPtr &reference_actor, const ActorPtr &other_actor, const bool detect_collision);
